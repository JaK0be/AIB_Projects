...
-- -----------------------------------------------------
-- Table `DW_URG`.`dim_data_hora`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DW_URG`.`dim_data_hora` (
...
-- -----------------------------------------------------
-- Table `DW_URG`.`dim_sexo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DW_URG`.`dim_sexo` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `DW_URG`.`dim_data_nascimento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DW_URG`.`dim_data_nascimento` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `dia` INT NOT NULL,
  `mes` INT NOT NULL,
  `ano` INT NOT NULL,
  `data_nascimento` DATE NOT NULL,
  `classificacao` VARCHAR(55) NOT NULL,
  `data_alteracao` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DW_URG`.`factos_urgencias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DW_URG`.`factos_urgencias` (
  ...
  CONSTRAINT `fk_factos_urgencias_dim_data_hora`
    ...
    REFERENCES `DW_URG`.`dim_data_hora` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
